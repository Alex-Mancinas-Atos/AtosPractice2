...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"app.ts":[function(require,module,exports) {
"use strict";
...
var extractData = function extractData(paisesData) {
  var body = '';

  var _loop = function _loop(i) {
    var item = void 0;
    var languages = Object.keys(paisesData[i].languages || {}).map(function (key) {
      return paisesData[i].languages[key];
    });
    body += "<tr>\n            \n            <td>".concat(paisesData[i].name.official, "</td>\n            <td>").concat(paisesData[i].capital, "</td>\n            <td>").concat(paisesData[i].region, "</td>\n            <td >").concat(reduceToString(languages, "No capital"), "</td>\n            <td>").concat(paisesData[i].population, "</td>\n            <td><img src=\"").concat(paisesData[i].flags.png, "\"></td>\n            \n        </tr>");
  };

  for (var i = 0; i < paisesData.length; i++) {
    _loop(i);
  }
...
var reduceToString = function reduceToString(str_arr, default_message) {
  var valid_array = _typeof(str_arr) === "object" && str_arr.length > 0;
  return valid_array ? str_arr.reduce(function (f, l) {
